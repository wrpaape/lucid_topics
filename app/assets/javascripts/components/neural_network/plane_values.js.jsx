...
var PlaneValues = React.createClass({
  ...
  componentDidUpdate: function() {
    ...
    var drawInput = function() {
      ...
      drawArrow(ctxInput, xo1, yo, r, 2 * r / 5, angle, '#FFBE44');
      ctxInput.font = '18px monaco, Consolas, "Lucida Console", monospace';
      ctxInput.fillStyle = '#FFBE44';
      ctxInput.fillText('velocity', xo1, heightText);
      ...
      drawArrow(ctxInput, xo2, yo, r, 2 * r / 5, angle, '#FD7780');
      ctxInput.fillStyle = '#FD7780';
      ctxInput.fillText('position', xo2, heightText);
